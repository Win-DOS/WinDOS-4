...
IF EXIST "C:\Users\%username%\WinDOS-4.2-Patch1\ver42.signature" msg * You are up-to-date! ELSE goto DownUpdate.
:DownUpdate
cls
...
MOVE /Y C:\Users\%username%\Downloads\WinDOS-4.2 C:\Users\%username%\
timeout 5 >NUL
echo.
echo Finish!
